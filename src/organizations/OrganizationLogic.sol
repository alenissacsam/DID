...
abstract contract OrganizationLogic is OrganizationStorage, AccessControl, ReentrancyGuard {
    ...
    constructor(address _certificateManager, address _trustScore, address _verificationLogger) {
