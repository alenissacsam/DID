...
contract IncomeVerificationManager is AccessControl, ReentrancyGuard {
        ...
        onlyRole(INCOME_ORACLE_ROLE)
    {
        ...
        if (success) {
            ...
            userRegistry.updateVerificationStatus(user, IUserIdentityRegistry.VerificationKind.Income, true);
    ...
    function revokeIncomeVerification(address user, string memory reason) external onlyRole(VERIFIER_ROLE) {
        ...
        userRegistry.updateVerificationStatus(user, IUserIdentityRegistry.VerificationKind.Income, false);
